...
def fixed_depth_search(depth, left_cells, ref_path_list, ref_pieces_list, ref_piece_sum_list, ref_map_arr, modulo_num):
    ...
    for start_row_idx in range(0, max_row_idx - cur_piece_row_num):
        for start_col_idx in range(0, max_col_idx - cur_piece_col_num):
            ...
            if fixed_depth_search(depth + 1, ref_path_list, ref_pieces_list, ref_piece_sum_list, ref_map_arr, modulo_num):
                return True
            else:
