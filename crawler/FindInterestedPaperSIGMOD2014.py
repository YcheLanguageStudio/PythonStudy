...
def loadData(url):
    ...
    # else:
    #     request.add_header('Cookie',
    #                        "CFID=574463805; CFTOKEN=23438085; IP_CLIENT=7667124; SITE_CLIENT=9665324; INDIV_CLIENT=NO; INDIV_CLIENT=NO; AK=expires%3D1452498644%7Eaccess%3D%2F10%2E1145%2F2600000%2F2593661%2F%2A%7Emd5%3D9befe0b1fd40be7c4a8cbd459a70158b")
...
if __name__ == '__main__':
    ...
    path = r'/home/cheyulin/Documents/Paper/GraphInDB/sigmod2014/'
    page = loadData('http://www.sigmod2014.org/research_list.shtml')
    soup = BeautifulSoup(page, from_encoding='utf-8')
    paper_info = soup.find_all('div', {'id': 'maincontent'})[0].find_all('li');
    for paper in paper_info:
        # print paper
        # i += 1
        paper_name = str(paper.contents[0]).strip()
        # print paper_name
